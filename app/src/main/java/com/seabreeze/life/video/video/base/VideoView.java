...
import com.seabreeze.life.video.utils.NetInfoModule;
...
public abstract class VideoView extends TextureRenderView implements MediaPlayerListener {
    ...
    protected void startPrepare() {
        ...
        getVideoManager().prepare(mUrl, mSpeed, mLooping, (mMapHeadData == null) ? new HashMap<String, String>() : mMapHeadData);

package com.seabreeze.life.video.view;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                FrameLayout.LayoutParams lParams = (FrameLayout.LayoutParams) mBaseVideoPlayer.getLayoutParams();
            ...
            case MotionEvent.ACTION_MOVE:
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) mBaseVideoPlayer.getLayoutParams();

package com.seabreeze.life.widget.like;
...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        ivStar.setImageResource(isChecked ? R.drawable.like_enable_icon : R.drawable.like_icon);
        ...
        if (onLikeClickListener != null) {
            onLikeClickListener.onLikeClickListener(isChecked);
        }
    }
    ...
    public interface OnLikeClickListener {
        void onLikeClickListener(boolean isChecked);
    }
}
